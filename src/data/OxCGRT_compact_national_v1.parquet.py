...
sel_cols = ['CountryName', 'Date', 'Jurisdiction', 'ConfirmedCases'] + closure_policies + economic_policies + health_policies + vaccination_policies
...
df_long = df.melt(id_vars=['CountryName', 'Jurisdiction', 'Date', 'ConfirmedCases'], var_name='PolicyType', value_name='PolicyValue')
