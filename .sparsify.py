...
def main():
    ...
    parser.add_argument('-t', '--tolerance', type=float, default=0.0001,help='Input file')
    ...
    sum_diff_timestep = sum_diff_timestep[(sum_diff_timestep.diff_L >= -args.tolerance) & (sum_diff_timestep.diff_L <= args.tolerance)][['row_id', 'timestep']]
    ...
    anti_join.to_parquet(f"{args.input.stem}_sparsified.parquet", index=False)
